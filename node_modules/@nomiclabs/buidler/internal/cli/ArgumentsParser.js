...
class ArgumentsParser {
    ...
    static cLAToParamName(cLA) {
        if (cLA.toLowerCase() !== cLA) {
            throw new errors_1.BuidlerError(errors_list_1.ERRORS.ARGUMENTS.PARAM_NAME_INVALID_CASING, {
                param: cLA
            });
        }
    ...
    parseBuidlerArguments(buidlerParamDefinitions, envVariableArguments, rawCLAs) {
        ...
        for (let i = 0; i < rawCLAs.length; i++) {
            ...
            if (taskName === undefined) {
                ...
                if (!this._isCLAParamName(arg, buidlerParamDefinitions)) {
                    throw new errors_1.BuidlerError(errors_list_1.ERRORS.ARGUMENTS.UNRECOGNIZED_COMMAND_LINE_ARG, { argument: arg });
                }
        ...
        return {
            buidlerArguments: this._addBuidlerDefaultArguments(buidlerParamDefinitions, envVariableArguments, buidlerArguments),
            taskName,
            unparsedCLAs
        };
    }
    ...
    _parseTaskParamArguments(taskDefinition, rawCLAs) {
        ...
        for (let i = 0; i < rawCLAs.length; i++) {
            ...
            if (!this._isCLAParamName(arg, taskDefinition.paramDefinitions)) {
                throw new errors_1.BuidlerError(errors_list_1.ERRORS.ARGUMENTS.UNRECOGNIZED_PARAM_NAME, {
                    param: arg
                });
            }
    ...
    _addBuidlerDefaultArguments(buidlerParamDefinitions, envVariableArguments, buidlerArguments) {
        return Object.assign({}, envVariableArguments, buidlerArguments);
    }
    ...
    _parseArgumentAt(rawCLAs, index, paramDefinitions, parsedArguments) {
        ...
        if (parsedArguments[paramName] !== undefined) {
            throw new errors_1.BuidlerError(errors_list_1.ERRORS.ARGUMENTS.REPEATED_PARAM, {
                param: claArg
            });
        }
    ...
    _parsePositionalParamArgs(rawPositionalParamArgs, positionalParamDefinitions) {
        ...
        for (let i = 0; i < positionalParamDefinitions.length; i++) {
            ...
            if (rawArg === undefined) {
                if (!definition.isOptional) {
                    throw new errors_1.BuidlerError(errors_list_1.ERRORS.ARGUMENTS.MISSING_POSITIONAL_ARG, {
        ...
        if (!hasVariadicParam &&
            ...
            throw new errors_1.BuidlerError(errors_list_1.ERRORS.ARGUMENTS.UNRECOGNIZED_POSITIONAL_ARG, {
