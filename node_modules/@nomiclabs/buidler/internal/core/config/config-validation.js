...
const node_1 = require("../../buidler-evm/provider/node");
    ...
    if (config !== undefined && typeof config.networks === "object") {
        ...
        if (buidlerNetwork !== undefined) {
            if (buidlerNetwork.hardfork !== undefined &&
                !node_1.SUPPORTED_HARDFORKS.includes(buidlerNetwork.hardfork)) {
                errors.push(`BuidlerConfig.networks.${constants_1.BUIDLEREVM_NETWORK_NAME}.hardfork is not supported. Use one of ${node_1.SUPPORTED_HARDFORKS.join(", ")}`);
            }
