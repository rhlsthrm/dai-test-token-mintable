...
class SolidityTracer {
    ...
    tryToDecodeMessageTrace(messageTrace) {
        ...
        return Object.assign({}, messageTrace, { bytecode: this._contractsIdentifier.getBytecodeFromMessageTrace(messageTrace), steps: messageTrace.steps.map(s => message_trace_1.isEvmStep(s) ? s : this.tryToDecodeMessageTrace(s)) });
    }
