...
function toRequest(params) {
    return Object.assign({ apikey: params.apiKey, module: "contract", action: "verifysourcecode", contractaddress: params.contractAddress, sourceCode: params.sourceCode, contractname: params.contractName, compilerversion: params.compilerVersion, optimizationUsed: params.optimizationsUsed ? 1 : 0, runs: params.runs, constructorArguements: params.constructorArguments }, parseLibraries(params.libraries));
}
